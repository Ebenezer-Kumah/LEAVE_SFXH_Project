...
// Get approved leaves for the department
...
<div class="page-header">
    <h2>Team Calendar - <?php echo $department['department_name']; ?></h2>
    <p>View your team's leave schedule and availability.</p>
</div>
...
<div class="dashboard-cards">
    <div class="card">
        ...
        <div class="card-footer">
            <i class="fas fa-info-circle"></i> Total members
        </div>
    </div>
...
<div class="content-row">
    <div class="content-col">
        <div class="content-card">
            <div class="card-header">
                <h3>Team Calendar - <?php echo date('F Y'); ?></h3>
                                            ...
                                            <div class="calendar-day <?php echo $is_today ? 'today' : ''; ?> <?php echo $is_weekend ? 'weekend' : ''; ?>">
                                                ...
                                                <div class="day-leaves">
                                                    <?php foreach (array_slice($day_leaves, 0, 3) as $leave): ?>
                                                        <div class="leave-event" style="border-left: 3px solid #<?php echo substr(md5($leave['employee_name']), 0, 6); ?>" title="<?php echo htmlspecialchars($leave['employee_name']); ?> - <?php echo $leave['leave_type']; ?>">
                                        ...
                                        <div class="all-day-events">
                                            <?php foreach ($leave_events as $event): ?>
                                                <div class="all-day-event" style="border-left: 3px solid #<?php echo $event['color']; ?>">
                                                    <?php echo $event['employee']; ?> (<?php echo $event['type']; ?>)
                                                </div>
                                            <?php endforeach; ?>
                                        </div>
                                    <?php endif; ?>
            ...
            <div class="card-body">
                ...
                <?php if (!empty($upcoming_leaves)): ?>
                    <div class="upcoming-leaves-list">
                        <?php foreach (array_slice($upcoming_leaves, 0, 5) as $leave): 
                            $start = new DateTime($leave['start_date']);
                            $end = new DateTime($leave['end_date']);
                        ...
                        ?>
                            <div class="upcoming-item">
                                ...
                                <div class="upcoming-details">
                                    ...
                                    <div class="upcoming-type"><?php echo $leave['leave_type']; ?></div>
                                    <div class="upcoming-duration"><?php echo $leave['duration_days']; ?> days</div>
                                </div>
        ...
        <div class="content-card">
            ...
            <div class="card-body">
                <div class="quick-actions">
                    <a href="?page=requests" class="quick-action-btn">
